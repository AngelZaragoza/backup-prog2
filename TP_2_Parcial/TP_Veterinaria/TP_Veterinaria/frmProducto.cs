...
namespace TP_Veterinaria
{
    public partial class frmProducto : Form
    {
        ...
        private void cargarCombo(ComboBox combo, string nombreTabla)
        {
            ...
            //combo.ValueMember = dt.Columns["idMarca"].ColumnName;
        ...
        private bool existe(int pk)
        {
            ...
            for (int i = 0; i < cont; i++)
            {
                ...
                {
                    MessageBox.Show("El código que intenta cargar ya existe. Intente uno diferente","Error",
                        MessageBoxButtons.OK,
                        MessageBoxIcon.Hand);
                    txtCod.SelectAll();
                    return true;
            ...
            if (lstProductos.SelectedIndex >= 0)
            {
                ...
                else
                {
                    MessageBox.Show("Este Producto fue marcado como borrado."
                        + "\nPuede intentar darlo de alta nuevamente", "Error",
                        MessageBoxButtons.OK,
