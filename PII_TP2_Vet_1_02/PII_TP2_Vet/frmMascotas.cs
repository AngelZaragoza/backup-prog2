...
{ 
    public partial class frmMascotas : Form
    {
        ...
        public frmMascotas(AccesoDato origen)
        {
            InitializeComponent();
            ...
            //EL ORIGEN DE DATOS FUE CREADO EN EL FRMPRINCIPAL
            //Y PASADO POR PARAMETRO AL CONSTRUCTOR DE ESTE FORM
            //ACA ABAJO LO ASIGNAMOS AL OBJETO ADM
            adm = origen;
        }
